...
import tetris3.Shape.Tetrominoes;
...
public class Board extends JPanel implements ActionListener
{
    ...
    // How the game determains when the shape is done falling
    private void pause()
    {
        if (!isStarted)
            return;
    ...
    // Paints each shape as they move down
    ...
    // The actual movement of each shape downward
    ...
    // Creating the next piece after previous has finished falling
